...
const seo = {
  title: "Varun Batra",
  description:
    "Discover a showcase of my creative endeavors and accomplishments, as I invite you to delve into a visual journey that captures my passion, talent, and expertise.",
  og: {
    title: "Varun Batra",
    type: "website",
...
const greeting = {
  ...
  subTitle:
    "Discover a showcase of my creative endeavors and accomplishments, as I invite you to delve into a visual journey that captures my passion, talent, and expertise.",
  resumeLink:
    "https://drive.google.com/file/d/1U9-9PRuZza3_QBQfrt97oxpreBD7WVmQ/view?usp=sharing",
  ...
  data: [
    {
      ...
      skills: [
        "⚡ Building responsive website front end using React and JavaScript.",
        "⚡ Building a seamless connection between the backend and frontend utilizing MongoDB as the database.",
